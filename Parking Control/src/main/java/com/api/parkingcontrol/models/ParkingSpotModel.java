...
public class ParkingSpotModel implements Serializable {
    ...
    private UUID id; //arquitetura de microsserviçoes -identificadfor distribuídos

    @Column(nullable = false, unique = true, length = 10)//não nulo, campo único, caracteres limitados
